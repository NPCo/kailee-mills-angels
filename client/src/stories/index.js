...
import AngelEditForm from '../components/AngelEditForm';
...
storiesOf('AngelEditForm', module)
  .add('Blank', () => <AngelEditForm onValueChange={action('Edited')} removeAngel={action('Delete')} />)
  .add('Populated', () => <AngelEditForm angel={angelData[0]} onValueChange={action('Edited')} removeAngel={action('Delete')} />)

storiesOf('EditableAngelGrid', module)
  .add('desktop', () => <EditableAngelGrid angels={angelData} />)